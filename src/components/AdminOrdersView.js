...
import { brl, formatDateTime, formatPhone } from '@/lib/format'
            ...
            <div className="admin-actions">
              {order.status !== 'on_the_way' ? (
                <button
                  ...
                  onClick={() =>
                    changeStatus(order.id, 'on_the_way', `Pedido #${order.code} saiu para entrega`)
                  }
              ...
              {order.status !== 'delivered' ? (
                <button
                  ...
                  onClick={() =>
                    changeStatus(order.id, 'delivered', `Pedido #${order.code} marcado como entregue`)
                  }
                  disabled={saving === order.id}
                >
